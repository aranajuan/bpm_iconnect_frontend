 ...
 *   https://datatables.net/download/#ju/dt-1.10.11,af-2.1.1,b-1.1.2,r-2.0.2
 *
 * Included libraries:
 *   DataTables 1.10.11, AutoFill 2.1.1, Buttons 1.1.2, Responsive 2.0.2
 */
...
(function( $, window, document, undefined ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		build:"ju/dt-1.10.11,af-2.1.1,b-1.1.2,r-2.0.2",
